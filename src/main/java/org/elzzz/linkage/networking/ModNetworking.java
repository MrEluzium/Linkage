...
import org.elzzz.linkage.networking.packet.ExecuteTeleportationC2SPacket;
...
public class ModNetworking {
    ...
    public static final Identifier EXECUTE_TELEPORTATION = new Identifier(LinkageMod.MOD_ID, "execute_teleportation");
    ...
    public static void registerC2SPackets() {
        ...
        ServerPlayNetworking.registerGlobalReceiver(EXECUTE_TELEPORTATION, ExecuteTeleportationC2SPacket::receive);
    }
